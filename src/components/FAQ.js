...
const faqs = [
  ...
  { q:'What is LTL and why is it better for my business?', a:"Less-than-Truckload (LTL) means you only pay for the portion of the truck your cargo uses — significantly reducing freight costs for SMBs." },
  { q:'How do you handle customs clearance?', a:"We have licensed customs brokers who handle all documentation, import/export filings, duty calculations, and regulatory compliance." },
  ...
  { q:'How quickly can you provide a freight quote?', a:"We respond to all quote requests within 2 business hours. For urgent shipments, call us directly." },
  { q:'Which shipping modes do you offer?', a:"Air freight, ocean freight (FCL & LCL), road freight (LTL & FTL), and multimodal combinations." },
  { q:'Are my shipments insured?', a:"Yes. We work with top cargo insurance providers to protect against loss, damage, and delay. Coverage included in your quote." },
  { q:'What is your service area?', a:"We operate globally — headquartered in Houston, TX with strong North American coverage and routes to Europe, Asia, Africa, and Latin America." },
];
      ...
      <div className="container">
        <div className="grid-2">
          <div style={{ position:'sticky', top:100 }}>
            ...
            <h2 className="heading" style={{ fontSize:'clamp(2.2rem,3.5vw,3.2rem)', color:'#1E0A4F', marginBottom:16 }}>FREQUENTLY<br/>ASKED<br/><span style={{ color:'#1A8A3C' }}>QUESTIONS</span></h2>
            <p style={{ color:'#6B7280', fontSize:'1rem', lineHeight:1.7, marginBottom:28 }}>Can't find your answer? <a href="mailto:info@docargoconnect.com" style={{ color:'#2D0F6B', fontWeight:700 }}>Email us directly.</a></p>
